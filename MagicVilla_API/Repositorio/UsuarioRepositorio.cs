...
namespace MagicVilla_API.Repositorio
{
	public class UsuarioRepositorio : IUsuarioRepositorio
	{
        ...
        public UsuarioRepositorio( ApplicationDbContext db,IConfiguration configutarion, UserManager<UsuarioAplicacion> userManager,
									IMapper mapper, RoleManager<IdentityRole> rolemanager)
		{ 
			_db= db;
			secretKey = configutarion.GetValue<string>("ApiSettings:Secret");
		...
		public async Task<LoginResponseDTO> Login(LoginRequestDTO loginRequestDTO)
		{
			...
			//Si usuario existe regresamos JW TOKEN
			...
			try
			{
				...
				if (resultado.Succeeded)
				{
					if (!_roleManager.RoleExistsAsync("admin").GetAwaiter().GetResult())
					{
                        ...
                        //await _roleManager.CreateAsync(new IdentityRole("cualquier rol"));
                    }
